...
- **Dictionary content** (every JSON file under `cards/`, the generated `docs/data/glossary.json`, and the prose in `PHILOSOPHY.md`) is licensed under **[Creative Commons Attribution-ShareAlike 4.0](cards/LICENSE)**. Reuse and adapt freely; credit *LLM Dictionary* and share derivative content under the same license.
